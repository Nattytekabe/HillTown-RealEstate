...
$sql = "SELECT COUNT(*) AS total FROM `property` WHERE `property_type` = 'Apartment'";
            ...
            <div class="row clearfix">
                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5">
                    <h4>
                        ...
                        <span class="heading">Apartments Properties Grid</span>
                    </h4>
                </div>
                    ...
                    <div class="search-area">
                        <select onchange="location = this.value;"  class="selectpicker search-fields" name="location">
                           <option value="properties.php">All</option>
                            ...
                            <option selected="yes" value="properties-apartment.php">Apartments</option>
