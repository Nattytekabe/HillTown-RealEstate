...
$sql = "SELECT COUNT(*) AS total from property WHERE `id` = $id AND `property_type` = 'Office'";
...
$query=mysqli_query($con,"select * from property WHERE `id` = $id AND `property_type` = 'Office' ");
