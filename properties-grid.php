            ...
            <div class="row clearfix">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                    <div class="sorting-options clearfix">
                        <a href="properties-grid.php" class="change-view-btn active-view-btn"><i class="fa fa-th"></i></a>
                        <a href="properties.php" class="change-view-btn "><i class="fa fa-th-large"></i></a>
                    </div>
