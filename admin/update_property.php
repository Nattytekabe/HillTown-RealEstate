                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="text" name="property_owner" value="<?php echo $property_owner;?>" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select  required type="text" name="property_type" value="<?php echo $property_type;?>" class="form-control">
                                                    <option selected="chk-col-yellow" disabled="yes" >-Select Type-</option>
                                                     <option value="Residential">Resident   ial</option>
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="text" name="lot_size" value="<?php echo $lot_size;?>" class="form-control">
                                     ...
                                     <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="text" name="land_area" value="<?php echo $land_area;?>" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="number" name="sqr_price" value="<?php echo $sqr_price;?>" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="add" value="<?php echo $address;?>" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea required name="description" class="form-control"><?php echo $description;?></textarea>
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" class="form-control" value="<?php echo $video;?>" required name="video">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" class="form-control" value="<?php echo $location ;?>" required name="location">
                               ...
                               <h4 style="text-align: center;">Condition</h4>
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="number" name="kichan" value="<?php echo $kichan;?>" class="form-control">
