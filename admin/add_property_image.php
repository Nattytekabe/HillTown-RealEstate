...
if(isset($submit))
{
  ...
  $query="insert into images values('$id','$file','$file1','$file2','$file3','$property_id')";  
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-3 col-sm-3 col-xs-6">
                                        <select class="form-control show-tick" name="property_id">
                                            <option disabled selected>--Select Property Title--</option>
                                            <?php
                      ...
                      <option name="property_id" value="<?php echo $res['id'];?>"><?php echo $res['title'];?>    
                      </option>  
