...
else
{
  ...
  $query=mysqli_query($con,"update images set image1='$file1',image2='$file2',image3='$file3',image4='$file4',floorplan='$file5' where property_id='$image_id'");
  ...
  move_uploaded_file($_FILES['file4']['tmp_name'],"images/property_image/".$_FILES['file4']['name']); 
  move_uploaded_file($_FILES['file5']['tmp_name'],"images/floorplan/".$_FILES['file5']['name']); 
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <h3>Floor Plan</h3>
                                    <input class="form-control"  name="file5" type="file" multiple /></br>
                                    <img src="images/floorplan/<?php echo $img5;?>" width="200">
                                </div></div>
