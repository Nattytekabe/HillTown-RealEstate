...
<?php include('include/sidebar.php');?>
        ...
        <section class="content">
             ...
             <li><a  href="view_property.php">All Properties</a></li>
                <li><a  href="view_property_residential.php">Residentials</a></li>
                <li><a  href="view_property_apartment.php">Apartments</a></li>
                <li><a  href="view_property_commercial.php">Commercials</a></li>
                <li><a  href="view_property_office.php">Office's</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
...
$query=mysqli_query($con,"select * from property where property_type = 'Residential'");
