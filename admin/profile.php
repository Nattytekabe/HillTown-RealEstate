            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12">
                    <div class="card profile-card">
                        <div  class="profile-header" style=" color: indigo;">&nbsp;</div>
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="images/<?php echo $image; ?>" alt="Admin - Profile Image" width = "100px" />
                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="profile_settings">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="NameSurname" name="NameSurname" placeholder="Name Surname" value="<?php echo $res['username'];?>"  required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
