...
$sql = "SELECT COUNT(*) AS total FROM `property` WHERE `property_type` = 'Residential'";
            ...
            <div class="row clearfix">
                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5">
                    <h4>
                        ...
                        <span class="heading">Residential Properties Grid</span>
                    </h4>
                </div>
                    ...
                    <div class="search-area">
                        <select onchange="location = this.value;"  class="selectpicker search-fields" name="location">
                           <option value="properties.php">All</option>
                               <option selected="yes" value="properties-residentials.php">Residentials</option>
                            <option value="properties-apartment.php">Apartments</option>
                             <option value="properties-commercial.php">Commercial</option>
